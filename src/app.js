const projectApp = () => {
  ...
  const createProject = (event) => {
                        ...
                        <div class="flex items-center gap-4 relative">
                            ...
                            <div class="settings-menu right-0 bottom-[120%] hidden border border-white/10 bg-gray-900/90 absolute rounded-sm min-w-37.5 ">
                                <ul>
                                    ...
                                    <li>
                                        <button
                                            class="archive-button flex items-center gap-2 py-1.5 px-3 text-sm hover:bg-white/5 w-full cursor-pointer text-gray-400 hover:text-gray-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                stroke="currentColor" class="size-5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <li>
                                        <button
                                            class="complete-button flex items-center gap-2 py-1.5 px-3 text-sm hover:bg-white/5 w-full cursor-pointer text-gray-400 hover:text-gray-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                stroke="currentColor" class="size-5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    // Archive-knapp
    const archiveButton = projectElement.querySelector(".archive-button")

    // Complete-knapp
    const completeButton = projectElement.querySelector(".complete-button")
    ...
    // Eventlyssnare för status-knappar
